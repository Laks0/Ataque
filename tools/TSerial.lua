--- Tserial v1.51, a simple table serializer which turns tables into Lua script
...
function Tserial.pack(t, drop, indent)
	...
	for k, v in pairs(t) do if not (type(k)=="number" and k<=l and k==math.floor(k)) then s = s..proc(k, v) end end
